...
uses GlobalVar, UdmDBCommon, UfmContactsEdit, uSendingSMS;
...
begin
  ...
  try
    ...
    fmContactsEdit.ShowModal;
    if fmContactsEdit.ModalResult = mrOk then begin
      COMPANY_CONTACTS_UPD.ParamByName('ID').Value := gridContactsID.EditValue;
      ...
      gridContacts.DataController.SaveBookmark;
      ds_COMPANY_CONTACTS_SEL.DataSet.Refresh;
      gridContacts.DataController.GotoBookmark;
      cxGrid1.SetFocus;
    end;
  finally
    fmContactsEdit.Free;
