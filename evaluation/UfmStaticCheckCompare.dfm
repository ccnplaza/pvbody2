object fmStaticCheckCompare: TfmStaticCheckCompare
  Left = 0
  Top = 0
  Caption = #51221#51201#54217#44032' '#48708#44368
  ClientHeight = 638
  ClientWidth = 1095
  Color = clBtnFace
    ...
    object cxGrid1: TcxGrid
      ...
      object gridCompare: TcxGridDBBandedTableView
        ...
        object gridCompareCHECK_BODY_ID: TcxGridDBBandedColumn
          ...
          Properties.ListSource = d_static_body
        ...
        object gridCompareCHECK_POINT_ID: TcxGridDBBandedColumn
          ...
          Properties.ListSource = d_static_checkpoint
          Position.BandIndex = 0
          Position.ColIndex = 3
          Position.RowIndex = 0
        end
  ...
  object t_static_body: TUniTable
    TableName = 'STATIC_BODY'
    Connection = dmDBCommon.UniDBConnection
    Left = 344
    Top = 456
    object t_static_bodyID: TStringField
      FieldName = 'ID'
      Required = True
      Size = 17
    end
    object t_static_bodyBODY_POINT: TStringField
      FieldName = 'BODY_POINT'
      Size = 15
    end
  end
  object d_static_body: TDataSource
    DataSet = t_static_body
    Left = 344
    Top = 504
  end
  object t_static_checkpoint: TUniTable
    TableName = 'STATIC_CHECKPOINT'
    Connection = dmDBCommon.UniDBConnection
    MasterFields = 'ID'
    DetailFields = 'BODY_ID'
    Left = 448
    Top = 456
    object t_static_checkpointID: TStringField
      FieldName = 'ID'
      Required = True
      Size = 17
    end
    object t_static_checkpointBODY_ID: TStringField
      FieldName = 'BODY_ID'
      Size = 17
    end
    object t_static_checkpointPOINT_NAME: TStringField
      FieldName = 'POINT_NAME'
      Size = 30
    end
    object t_static_checkpointPRACTICE_ID: TStringField
      FieldName = 'PRACTICE_ID'
      Size = 17
    end
  end
  object d_static_checkpoint: TDataSource
    DataSet = t_static_checkpoint
    Left = 448
    Top = 504
  end
  ...
  object q_result_compare: TUniQuery
    Connection = dmDBCommon.UniDBConnection
    SQL.Strings = (
      'select * from STATIC_RESULT_COMPARE'
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    PrintTitle = #51221#51201#54217#44032' '#44208#44284' '#48708#44368#54364
    Version = 0
    Left = 592
    Top = 136
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 41972.472296168980000000
      ReportTitle.Text = #51221#51201#54217#44032' '#44208#44284' '#48708#44368#54364
