...
var
  fmLectureMember: TfmLectureMember;
...
procedure TfmLectureMember.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TfmLectureMember.FormShow(Sender: TObject);
begin
  IsMyAction := False;
...
procedure TfmLectureMember.btnAddClick(Sender: TObject);
begin
...
procedure TfmLectureMember.btnAddCustLecClick(Sender: TObject);
var
  UID, CustName : string;
begin
...
procedure TfmLectureMember.btnBreakClick(Sender: TObject);
var
  toprow : Integer;
begin
...
procedure TfmLectureMember.btnCountDownClick(Sender: TObject);
var
...
procedure TfmLectureMember.btnCountUpClick(Sender: TObject);
var
...
procedure TfmLectureMember.btnCustInfoClick(Sender: TObject);
begin
...
procedure TfmLectureMember.btnDelCancelClick(Sender: TObject);
begin
...
procedure TfmLectureMember.btnDelClick(Sender: TObject);
begin
...
procedure TfmLectureMember.btnDelLecMemberClick(Sender: TObject);
begin
  if Application.MessageBox('선택한 자료를 삭제합니다.' + #13#10 + '삭제한 자료는 되살릴 수 없습니다.' +
...
procedure TfmLectureMember.btnEditClick(Sender: TObject);
begin
  fmHistoryEdit := TfmHistoryEdit.Create(Self);
  try
...
procedure TfmLectureMember.btnEditCustLecClick(Sender: TObject);
var
...
procedure TfmLectureMember.btnEndUpdateClick(Sender: TObject);
begin
  Screen.Cursor := crHourGlass;
  IsMyAction := True;
...
procedure TfmLectureMember.btnExcelActiveClick(Sender: TObject);
var
  filename : string;
...
procedure TfmLectureMember.btnFilterClearClick(Sender: TObject);
var
  fstr : string;
begin
  edtFind.Text := '';
...
procedure TfmLectureMember.btnFilterClick(Sender: TObject);
var
  fstr : string;
begin
  if icbCenter.EditValue > 0 then begin
...
procedure TfmLectureMember.btnFindEnderClick(Sender: TObject);
var
...
procedure TfmLectureMember.btnLectureClick(Sender: TObject);
begin
...
procedure TfmLectureMember.btnNoSMSClick(Sender: TObject);
var
  yesno : Integer;
begin
...
procedure TfmLectureMember.btnOutClick(Sender: TObject);
var
  uid, CustName : string;
...
procedure TfmLectureMember.btnReportClick(Sender: TObject);
begin
  dxComponentPrinter1.Preview(True);
end;

procedure TfmLectureMember.btnSaveChangeClick(Sender: TObject);
begin
...
procedure TfmLectureMember.btnSMSSendingClick(Sender: TObject);
var
...
procedure TfmLectureMember.btnViewClick(Sender: TObject);
begin
...
procedure TfmLectureMember.ShowMemberData;
begin
...
procedure TfmLectureMember.chkFilterClick(Sender: TObject);
begin
  gridLectureCust.FilterRow.Visible := chkFilter.Checked;
end;

procedure TfmLectureMember.e_dateChange(Sender: TObject);
begin
  btnView.Click;
end;

procedure TfmLectureMember.gridLectureCustCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
  ShowMemberData;
...
procedure TfmLectureMember.gridLectureCustCellDblClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfmLectureMember.gridLectureCustFocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
...
procedure TfmLectureMember.gridLectureCustIS_DONECustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure TfmLectureMember.gridLectureCustM_KINDCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure TfmLectureMember.gridLectureCustStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
var
...
procedure TfmLectureMember.icbCenterPropertiesCloseUp(Sender: TObject);
begin
  btnView.Click;
end;

procedure TfmLectureMember.s_dateChange(Sender: TObject);
begin
  btnView.Click;
  //btnEndUpdate.Click;
end;

procedure TfmLectureMember.UniAlerter1Event(Sender: TDAAlerter; const EventName,
  Message: string);
begin
...
initialization RegisterClasses([TfmLectureMember]);
