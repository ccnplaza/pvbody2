...
type
  TfmLectureCustomerRegist = class(TfmDialogParent)
    ...
    procedure edtCNAMEExit(Sender: TObject);
  private
...
begin
  ...
  try
    fmMemberConfirm.qryCustomer.ParamByName('C_ID').Value := LoginUserCompID;
    fmMemberConfirm.qryCustomer.ParamByName('C_NAME').Value := edtCNAME.Text;
...
procedure TfmLectureCustomerRegist.edtCNAMEExit(Sender: TObject);
begin
  inherited;
