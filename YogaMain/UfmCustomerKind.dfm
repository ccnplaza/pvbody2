object fmCustomerKind: TfmCustomerKind
  Left = 0
  Top = 0
  ...
  object cxGrid1: TcxGrid
    ...
    object gridCustKind: TcxGridDBTableView
      ...
      DataController.DataSource = dmDBCommon.d_customer_kind
      ...
      object gridCustKindID: TcxGridDBColumn
        DataBinding.FieldName = 'ID'
        HeaderAlignmentHorz = taCenter
      end
      object gridCustKindK_NAME: TcxGridDBColumn
        DataBinding.FieldName = 'K_NAME'
      end
    end
    object cxGrid1Level1: TcxGridLevel
      GridView = gridCustKind
    end
  end
end
