object fmToday: TfmToday
  ...
  object Q_LessonAttendance: TUniQuery
    Connection = dmDBCommon.UniDBConnection
    SQL.Strings = (
      'select '
      '        lesson_attendance.id,'
      '        lesson_attendance.att_date,'
      '        lesson_attendance.lec_code,'
      '        lesson_attendance.in_time,'
      '        lesson.l_name,'
      '        customer.cname,'
      '        customer.is_active'
      '    from customer'
      
        '       inner join lesson_attendance on (customer.uid = lesson_at' +
        'tendance.member_id)'
      
        '       inner join lesson on (lesson_attendance.lec_code = lesson' +
        '.id)'
      
        '       where (customer.company_id = :comp_id) and (lesson_attend' +
        'ance.att_date = :a_date);')
    Left = 528
    Top = 328
    ParamData = <
      item
    ...
    object Q_LessonAttendanceID: TStringField
      FieldName = 'ID'
      Required = True
      Size = 17
    end
    object Q_LessonAttendanceATT_DATE: TDateField
      FieldName = 'ATT_DATE'
    end
    object Q_LessonAttendanceLEC_CODE: TStringField
      FieldName = 'LEC_CODE'
      Size = 17
    end
    object Q_LessonAttendanceIN_TIME: TStringField
      FieldName = 'IN_TIME'
      Size = 5
    end
    object Q_LessonAttendanceL_NAME: TStringField
      FieldName = 'L_NAME'
      ReadOnly = True
      Size = 30
    end
    object Q_LessonAttendanceCNAME: TStringField
      FieldName = 'CNAME'
      ReadOnly = True
    end
    object Q_LessonAttendanceIS_ACTIVE: TSmallintField
      FieldName = 'IS_ACTIVE'
      ReadOnly = True
    end
  end
  object Q_LessonCustomer: TUniQuery
    Connection = dmDBCommon.UniDBConnection
    SQL.Strings = (
      'select '
      '        lesson_customer.id,'
      '        lesson_customer.reg_date,'
      '        lesson_customer.member_uid,'
      '        lesson_customer.start_date,'
      '        lesson_customer.end_date,'
      '        lesson_customer.lec_month,'
      '        lesson_customer.lec_code,'
      '        lesson_customer.company_id,'
      '        lesson_customer.is_done,'
      '        lesson_customer.m_kind,'
      '        lesson_customer.locker_no,'
      '        lesson_customer.new_or_renew,'
      '        lesson_customer.lec_desc,'
      '        lesson_customer.lec_price,'
      '        lesson_customer.pay_kind,'
      '        lesson_customer.out_date,'
      '        lesson_customer.out_price,'
      '        lesson_customer.out_kind,'
      '        lesson_customer.out_reason,'
      '        lesson_customer.used_cnt,'
      '        lesson_customer.break_start,'
      '        lesson_customer.break_end,'
      '        lesson_customer.center_id,'
      '        customer.cname,'
      '        customer.sex,'
      '        customer.ctel,'
      '        customer.is_active,'
      ...
      '    from customer'
        ...
        '       inner join lesson_customer on (customer.uid = lesson_cust' +
        'omer.member_uid)'
      
        '       where (customer.company_id = :comp_id) and (lesson_custom' +
        'er.reg_date between :s_date and :e_date)'
      '       order by lesson_customer.reg_date, lesson_customer.id;')
    Left = 144
    Top = 240
    ParamData = <
      item
    ...
    object Q_LessonCustomerID: TStringField
      FieldName = 'ID'
      Required = True
      Size = 17
    end
    object Q_LessonCustomerREG_DATE: TDateField
      FieldName = 'REG_DATE'
      Required = True
    end
    object Q_LessonCustomerMEMBER_UID: TStringField
      FieldName = 'MEMBER_UID'
      Required = True
      Size = 17
    end
    object Q_LessonCustomerSTART_DATE: TDateField
      FieldName = 'START_DATE'
    end
    object Q_LessonCustomerEND_DATE: TDateField
      FieldName = 'END_DATE'
    end
    object Q_LessonCustomerLEC_MONTH: TSmallintField
      FieldName = 'LEC_MONTH'
    end
    object Q_LessonCustomerLEC_CODE: TStringField
      FieldName = 'LEC_CODE'
      Size = 17
    end
    object Q_LessonCustomerCOMPANY_ID: TStringField
      FieldName = 'COMPANY_ID'
      Required = True
      Size = 17
    end
    object Q_LessonCustomerIS_DONE: TSmallintField
      FieldName = 'IS_DONE'
    end
    object Q_LessonCustomerM_KIND: TSmallintField
      FieldName = 'M_KIND'
    end
    object Q_LessonCustomerLOCKER_NO: TStringField
      FieldName = 'LOCKER_NO'
      Size = 10
    end
    object Q_LessonCustomerNEW_OR_RENEW: TSmallintField
      FieldName = 'NEW_OR_RENEW'
    end
    object Q_LessonCustomerLEC_DESC: TStringField
      FieldName = 'LEC_DESC'
      Size = 1024
    end
    object Q_LessonCustomerLEC_PRICE: TFloatField
      FieldName = 'LEC_PRICE'
    end
    object Q_LessonCustomerPAY_KIND: TSmallintField
      FieldName = 'PAY_KIND'
    end
    object Q_LessonCustomerOUT_DATE: TStringField
      FieldName = 'OUT_DATE'
      Size = 10
    end
    object Q_LessonCustomerOUT_PRICE: TFloatField
      FieldName = 'OUT_PRICE'
    end
    object Q_LessonCustomerOUT_KIND: TSmallintField
      FieldName = 'OUT_KIND'
    end
    object Q_LessonCustomerOUT_REASON: TStringField
      FieldName = 'OUT_REASON'
      Size = 50
    end
    object Q_LessonCustomerUSED_CNT: TSmallintField
      FieldName = 'USED_CNT'
    end
    object Q_LessonCustomerBREAK_START: TDateField
      FieldName = 'BREAK_START'
    end
    object Q_LessonCustomerBREAK_END: TDateField
      FieldName = 'BREAK_END'
    end
    object Q_LessonCustomerCENTER_ID: TSmallintField
      FieldName = 'CENTER_ID'
    end
    object Q_LessonCustomerCNAME: TStringField
      FieldName = 'CNAME'
      ReadOnly = True
    end
    object Q_LessonCustomerSEX: TStringField
      FieldName = 'SEX'
      ReadOnly = True
      Size = 2
    end
    object Q_LessonCustomerCTEL: TStringField
      FieldName = 'CTEL'
      ReadOnly = True
      Size = 50
    end
    object Q_LessonCustomerIS_ACTIVE: TSmallintField
      FieldName = 'IS_ACTIVE'
      ReadOnly = True
    end
    object Q_LessonCustomerSMS_YESNO: TSmallintField
      FieldName = 'SMS_YESNO'
      ReadOnly = True
    end
  end
  object q_ProductSale: TUniQuery
    Connection = dmDBCommon.UniDBConnection
    SQL.Strings = (
      'select id,'
      '             s_date,'
      ...
      '             CENTER_ID'
        ...
        '      from product_sale where (company_id = :comp_id) and (s_dat' +
        'e between :start_date and :end_date)'
      '      order by s_date, id')
    Left = 784
    Top = 136
    ParamData = <
    ...
    object q_ProductSaleID: TStringField
      FieldName = 'ID'
      Required = True
      Size = 17
    end
    object q_ProductSaleS_DATE: TDateField
      FieldName = 'S_DATE'
    end
    object q_ProductSaleITEM_ID: TIntegerField
      FieldName = 'ITEM_ID'
    end
    object q_ProductSaleS_DESC: TStringField
      FieldName = 'S_DESC'
      Size = 125
    end
    object q_ProductSaleS_QTY: TFloatField
      FieldName = 'S_QTY'
    end
    object q_ProductSaleQ_PRICE: TFloatField
      FieldName = 'Q_PRICE'
    end
    object q_ProductSaleT_PRICE: TFloatField
      FieldName = 'T_PRICE'
    end
    object q_ProductSalePAY_WAY: TSmallintField
      FieldName = 'PAY_WAY'
    end
    object q_ProductSalePAYED: TFloatField
      FieldName = 'PAYED'
    end
    object q_ProductSaleCENTER_ID: TIntegerField
      FieldName = 'CENTER_ID'
    end
  end
  object q_CashInout: TUniQuery
    Connection = dmDBCommon.UniDBConnection
    SQL.Strings = (
      'select id,'
      '             k_code,'
      ...
      '             CENTER_ID'
        ...
        '      from cash_inout where (company_id = :comp_id) and (c_date ' +
        '= :c_date)')
    Left = 984
    Top = 376
    ParamData = <
    ...
    object q_CashInoutID: TStringField
      FieldName = 'ID'
      Required = True
      FixedChar = True
      Size = 17
    end
    object q_CashInoutK_CODE: TIntegerField
      FieldName = 'K_CODE'
    end
    object q_CashInoutC_DESC: TStringField
      FieldName = 'C_DESC'
      Size = 50
    end
    object q_CashInoutCASH_IN: TFloatField
      FieldName = 'CASH_IN'
      DisplayFormat = '#,0'
    end
    object q_CashInoutCASH_OUT: TFloatField
      FieldName = 'CASH_OUT'
      DisplayFormat = '#,0'
    end
    object q_CashInoutLESSON_ID: TStringField
      FieldName = 'LESSON_ID'
      FixedChar = True
      Size = 17
    end
    object q_CashInoutPRODUCT_SALE_ID: TStringField
      FieldName = 'PRODUCT_SALE_ID'
      FixedChar = True
      Size = 17
    end
    object q_CashInoutCENTER_ID: TIntegerField
      FieldName = 'CENTER_ID'
    end
  end
end
