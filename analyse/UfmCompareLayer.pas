...
begin
  if (Sender as TAction).Checked then
    ImageEnViewCompare.MouseInteractLayers := [miRotateLayers]
  else
    ImageEnViewCompare.MouseInteractLayers := [miMoveLayers, miResizeLayers];
end;
...
begin
  ...
  begin
    ...
    imgMThumbView.ImageTopText[i] := 'Layer ' + inttostr(i);
