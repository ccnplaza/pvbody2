...
type
  TfrmImageEditor2 = class(TFrame)
    ...
    procedure PanelHandleClick(Sender: TObject);
  ...
  public
    ...
    procedure OpenToolsMode(OnOff : Boolean);
...
procedure TfrmImageEditor2.OpenToolsMode(OnOff: Boolean);
begin
  if OnOff = False then begin
...
procedure TfrmImageEditor2.PanelHandleClick(Sender: TObject);
begin
  if pnlTools.Width > 6 then begin
    pnlTools.Width := 6;
    PanelHandle.Caption := '◀';
  end else begin
    pnlTools.Width := 182;
