...
type
  TfmRequestRegistration2 = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    Label7: TLabel;
    Label8: TLabel;
...
var
  fmRequestRegistration2: TfmRequestRegistration2;

implementation

uses UfmUserAssign, UfmCompanySelect, GlobalVar, uLogin;

{$R *.dfm}

procedure TfmRequestRegistration2.btnSaveClick(Sender: TObject);
var
  pass1, pass2 : string;
begin
...
procedure TfmRequestRegistration2.edtLOGIN_IDChange(Sender: TObject);
begin
...
procedure TfmRequestRegistration2.FormShow(Sender: TObject);
begin
  LoginID_ISOK := False;
end;

procedure TfmRequestRegistration2.SaveRequests;
var
  user_id : string;
begin
  if LoginID_ISOK = True then begin
    ...
    COMPANY_INS.ParamByName('APPROVED').AsInteger := 1;
    COMPANY_INS.ParamByName('REG_DATE').AsDate := Date;
    COMPANY_INS.ParamByName('COMP_ID').AsString := LoginUserCompID;
...
procedure TfmRequestRegistration2.SetRegistryValue(ComputerID : string);
var
  Registry: TRegistry;
  GUID : string;
begin
...
procedure TfmRequestRegistration2.btnCheckUserClick(Sender: TObject);
var
  qUser : TUniQuery;
  login_id : string;
begin
